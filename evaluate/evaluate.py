...
eval_roots = dict()
datasets = ['CoCA', 'CoSOD3k', 'CoSal2015','RGBD_CoSeg183', 'RGBD_CoSal1k', 'RGBD_CoSal150']

for dataset in datasets:
    roots = {'gt': '/hy-tmp/DCFM-CoSOD_Depth/Datasets_depth/Depth_test_dataets/{}/gts/'.format(dataset),
             'pred': '/hy-tmp/DCFM-CoSOD_Depth/CoSODmaps/pred/{}/'.format(dataset)}
